...
description: When to trigger, what it does. This is the primary triggering mechanism - include both what the skill does AND specific contexts for when to use it. All "when to use" info goes here, not in the body. Note: currently Claude has a tendency to "undertrigger" skills -- to not use them when they'd be useful. To combat this, please make the skill descriptions a little bit "pushy". So for instance, instead of "How to draft a Form M prep sheet from extracted shipment data.", you might write "How to draft a Form M prep sheet from extracted shipment data. Make sure to use this skill whenever the user mentions Form M, import documentation, HS codes, NAFDAC/SON compliance, or wants to prepare any kind of pre-check for a shipment, even if they don't explicitly ask for a 'prep sheet.'"
